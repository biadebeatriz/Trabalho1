...
// instanciando o componente graphicCreator
        IgraphicCreator cgraphic = graphicCreatorFactory.create(false);
...
// Instanciando o componente View        
        IView view = ViewFactory.create();


// Instanciando o componente attTable
        IattTable attTable = attTableFactory.create();
// Conectando-o ao componente dataset,redutor e View
